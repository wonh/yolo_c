...
def create_modules(module_defs):
    ...
    for module_i, module_def in enumerate(module_defs):
        ...
        # Register module list and number of output filtersimg_size
...
class YOLOLayer(nn.Module):
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        if targets is None:
            ...
            # targets => (num, 6)  6=>(batch_index, cls, cen`1Qter_x, center_y, widht, height)
            # scaled_anchors => (3, 2)
            ...
            recall40 = torch.sum(iou40 * detected_mask) / (obj_mask.sum() + 1e-16)
